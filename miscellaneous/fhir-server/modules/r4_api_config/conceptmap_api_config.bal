    ...
    operations: [
        {
            ...
            active: true,
            information: {
                description: "Translate a concept from one value set to another",
                builtin: false,
                documentation: "http://hl7.org/fhir/OperationDefinition/ConceptMap-translate"
            }
        },
        {
            name: "closure",
            active: true,
            information: {
                description: "Maintain a closure table for subsumption-based queries",
                builtin: false,
                documentation: "http://hl7.org/fhir/OperationDefinition/ConceptMap-closure"
            }
        }
    ],
    serverConfig: (),
