...
-- H2-compatible equivalent of schema-postgresql.sql.
-- Used for local development only; PostgreSQL is the production target.
-- H2 differences: CLOB instead of JSONB, TIMESTAMP instead of TIMESTAMPTZ,
-- BIGINT AUTO_INCREMENT instead of BIGSERIAL, no partial indexes.
...
MERGE INTO "schema_version" ("version") KEY("version") VALUES (3);
