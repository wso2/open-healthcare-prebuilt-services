...
function testServiceWithSample() returns error? {
    international401:CapabilityStatement sampleCapabilityStatement = {
    ...
    international401:CapabilityStatement response = check clientEndpoint->get("/fhir/r4/metadata");
    test:assertEquals(response, sampleCapabilityStatement);
}

public function mockGenerateCapabilityStatement() returns international401:CapabilityStatement|error {
    international401:CapabilityStatement capabilityStatement = check mockReadFromConfigs();
    return capabilityStatement;
}

# method to build capability statement from metadata configurables
# + return - capabilitity statement json object
function mockReadFromConfigs() returns international401:CapabilityStatement|error {
    return {
        resourceType: CAPABILITY_STATEMENT,
        status: "active",
        kind: "instance",
