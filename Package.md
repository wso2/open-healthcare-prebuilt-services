...
# USCore FHIR Patient API

## Overview

This API provides a boilerplate code for rapid implementation of FHIR APIs and creating, accessing and manipulating FHIR resources.
...
| ballerinax/health.fhir.r4.uscore501         | 1.0.2   |
| ballerinax/health.base                      | 1.0.1   |

This API includes,

- Ballerina service for 'USCore Patient' FHIR resource with following FHIR interactions.
- Search
- Read
- Create
